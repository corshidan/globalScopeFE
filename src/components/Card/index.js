    ...
    <div className=' flex justify-center items-center '>
      <div className='flex flex-col items-center bg-white shadow-xl border border-gray-200 rounded-lg w-9/12 pb-2 hover:bg-green-300 '>
        ...
        <div className='flex flex-col items-center w-full'>
          ...
          <Link
            className='text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 text-center inline-flex items-center shadow-sm'
            to={path}
          >
            {buttonLabel}
          </Link>
