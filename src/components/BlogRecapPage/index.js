...
export default function BlogRecapPage() {
  ...
  return (
    <Layout>
      <div
        className={`${'flex flex-col items-center justify-center h-screen bg-contain bg-no-repeat bg-top pr-4 pl-4 pt-4   '}${
          css.photo
        }`}
      ...
      >
        <form className='justify-center items-center bg-white px-2 flex flex-col  bg-green-500 shadow-lg  opacity-95  h-full rounded-3xl '>
          <div className='border-2 bg-white  p-3 rounded-2xl shadow-inner  '>
